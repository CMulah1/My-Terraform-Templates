# Creating my AWS VPC with a public and private subnet, appropriate tables, an Internet Gateway, a NAT Gateway,
#and an EC2 instance in the public subnet. Config  is modular and will be expanded to include more complex infrastucture
# as needed.

# Componenets Needed:
# Terraform Installed: (Ensure I have Terraform installed on my local machine).
...
# Verifying Output:
# After the apply command completes, I can check the AWS Management Console to verify that the resources 
# have been created as expected. 
# The output my terminal will also provide the IDs of the created resources.